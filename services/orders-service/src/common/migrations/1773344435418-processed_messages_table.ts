...
export class ProcessedMessagesTable1773344435418 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "processed_messages" ("message_id" uuid NOT NULL, "processed_at" TIMESTAMP WITH TIME ZONE NOT NULL, "order_id" uuid NOT NULL, "handler" character varying(255), CONSTRAINT "PK_e357ddfac536c6c9708130ec3bc" PRIMARY KEY ("message_id"))`,
    );
    await queryRunner.query(
